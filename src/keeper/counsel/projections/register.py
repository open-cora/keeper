"""Hand Counsel's projections to the worker that advances them.

The composition root calls this once during startup, after `wire_counsel`
...
def register_counsel_projections(registry: ProjectionRegistry, deps: Kernel) -> None:
    """Register every Counsel projection with the worker's registry.

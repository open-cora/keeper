"""Hand Custody's projections to the worker that advances them.

The composition root calls this once during startup, after `wire_custody`
...
def register_custody_projections(registry: ProjectionRegistry, deps: Kernel) -> None:
    """Register every Custody projection with the worker's registry.
...
__all__ = ["register_custody_projections"]
